...
?>
	<div id='main'>
		<div id='artist' >
			<table align='center'  >
				<tr>
					<td colspan='2'><div class='bigger'>Gary Burris</div></td>
				</tr>
				<tr>
					<td colspan='2'><img src='artist.jpg' width='227' height='341'></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan='2'>
						<object id="dewplayer" height="200" width="240" name="dewplayer" data="http://softwindproductions.com/NewFolkrider/Other_midea/Music/dewplayer-playlist.swf?autostart=true&randomplay=true" type="application/x-shockwave-flash">
							...
							<param "="" ="="" value="showtime=true&autoreplay=true&xml=http://softwindproductions.com/NewFolkrider/Music/Artists/Gary_Burris/GB.xml" name="flashvars"/>
						</object>
					</td>
				</tr>
				<tr>
					<td> 
						<table>
							<tr>
								<a href='StayingTheCourse'>Staying The Course</a><br/>
							</tr>
							<tr>
								<a href='StayingTheCourse'><img src='StayingTheCourse/album.jpg' width='200' height='200'></a>
							</tr>
						</table>
					</td>
					<td> 
						<table>
							<tr>
								<a href='TheCoolBeyond'>The Cool Beyond</a><br/>
							</tr>
							<tr>
								<a href='TheCoolBeyond'><img src='TheCoolBeyond/album.jpg' width='200' height='200'></a>
							</tr>
						</table>
					</td>
				</tr>
