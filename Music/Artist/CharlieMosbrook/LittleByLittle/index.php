	...
	<div id='main'>
		<div id='album'>
			<table align='center'>
				<tr>
					<td colspan='2'>
						<div class='big' >Little by Little</div><div class='by' >by Charlie Mosbrook</div>
					</td>
				</tr>
				<tr>
					<td colspan='2' >
				...
				<tr>
					<td cellpadding="10"> 
						<div id='songs'>
							A Couple of Moments<br/>
							Walking Ain't Easy<br/>
							Dear Elijah*<br/>
							Coffee<br/>
							The Irony of Eggshells<br/>
							Circ-Us<br/>
							No Time<br/>
							Ask Twice<br/>
							Nothing To Lose<br/>
					...
					<td> 
						<object id="dewplayer" height="200" width="240" name="dewplayer" data="http://softwindproductions.com/NewFolkrider/Other_midea/Music/dewplayer-playlist.swf?autostart=true&randomplay=true" type="application/x-shockwave-flash">
							...
							<param "="" ="="" value="showtime=true&xml=http://softwindproductions.com/NewFolkrider/Music/Artists/Charlie_Mosbrook/Little_by_Little/Little_by_Little.xml" name="flashvars"/>
						</object>
					</td>
				</tr>
			</table>
