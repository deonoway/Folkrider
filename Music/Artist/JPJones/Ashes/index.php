	...
	<div id='main'>
		<div id='album'>
			<table align='center'>
				<tr>
					<td colspan='2'>
						<div class='big' >Ashes</div><div class='by' >by JP Jones</div>
					</td>
				</tr>
				<tr>
					<td colspan='2' >
				...
				<tr>
					<td cellpadding="10"> 
						<div id='songs'>
							What Took Ya So Long *<br/>
							Black and Blue<br/>
							Sandy<br/>
							Adios Columbus<br/>
							To Be a Man<br/>
							Bring a Gift<br/>
							Stand in the Fire *<br/>
							Some Sunny Day<br/>
							Don't Feel Guilty *<br/>
							Reincarnation Blues<br/>
							By a Thread<br/>
						</div>	
					</td>
					<td> 
						<object id="dewplayer" height="200" width="240" name="dewplayer" data="http://softwindproductions.com/NewFolkrider/Other_midea/Music/dewplayer-playlist.swf?autostart=true" type="application/x-shockwave-flash">
							...
							<param "="" ="="" value="showtime=true&autoreplay=true&xml=http://softwindproductions.com/NewFolkrider/Music/Artists/JP_Jones/Ashes/ashes.xml" name="flashvars"/>
						</object>
					</td>
				</tr>
			</table>
