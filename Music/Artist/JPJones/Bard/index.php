	...
	<div id='main'>
		<div id='album'>
			<table align='center'>
				<tr>
					<td colspan='2'>
						<div class='big' >Bard</div><div class='by' >by JP Jones</div>
					</td>
				</tr>
				<tr>
					<td colspan='2' >
				...
				<tr>
					<td cellpadding="10"> 
						<div id='songs'>
							Dreaming Stones Field<br/>
							Scotsman's Elegy<br/>
							Eurydice's Farwell<br/>
							Andy's Tune<br/>
							I'll Remember You<br/>
							The Passion of Harvey<br/>
							Us and Them<br/>
							Fanfare for a Fallen King<br/>
							Kerstin's Dream<br/>
							Jig<br/>
							Grief so Sweet<br/>
							A Winter's Tale<br/>
							Connie's Last Stand<br/>
						</div>
					</td>
					<td> 
						<object id="dewplayer" height="200" width="240" name="dewplayer" data="http://softwindproductions.com/NewFolkrider/Other_midea/Music/dewplayer-playlist.swf?autostart=true&randomplay=true" type="application/x-shockwave-flash">
							...
							<param "="" ="="" value="showtime=true&autoreplay=true&xml=http://softwindproductions.com/NewFolkrider/Music/Artists/JP_Jones/Bard/bard.xml" name="flashvars"/>
						</object>
					</td>
				</tr>
			</table>
