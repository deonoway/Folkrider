	...
	<div id='main'>
		<div id='album'>
			<table align='center'>
				<tr>
					<td colspan='2'>
						<div class='big' >Salvation Street</div><div class='by' >by JP Jones</div>
					</td>
				</tr>
				<tr>
					<td colspan='2' >
				...
				<tr>
					<td cellpadding="10"> 
						<div id='songs'>
							Nefertiti Smiling<br/>
							Salvation Street *<br/>
							Long Blue Train<br/>
							That's Right<br/>
							Nobody Speaks for Me<br/>
							Ordinary Day *<br/>
							Mole in the Ground<br/>
							This Is How I<br/>
							Dante's Highway *<br/>
							Almost Satisfied<br/>
							Back It Up<br/>
					...
					<td> 
						<object id="dewplayer" height="200" width="240" name="dewplayer" data="http://softwindproductions.com/NewFolkrider/Other_midea/Music/dewplayer-playlist.swf?autostart=true&randomplay=true" type="application/x-shockwave-flash">
							...
							<param "="" ="="" value="showtime=true&autoreplay=true&xml=http://softwindproductions.com/NewFolkrider/Music/Artists/JP_Jones/Salvation_Street/salvation_street.xml" name="flashvars"/>
						</object>
					</td>
				</tr>
			</table>
