	...
	<div id='main'>
		<div id='album'>
			<table align='center'>
				...
				<tr>
					<td colspan='2'>
						<div class='big' >Lady On The Bow</div>
					</td>
				</tr>
				<tr>
					<td colspan='2' >
				...
				<tr>
					<td colspan='2'> 
						<object id="dewplayer" height="200" width="240" name="dewplayer" data="http://softwindproductions.com/NewFolkrider/Other_midea/Music/dewplayer-playlist.swf?autostart=true" type="application/x-shockwave-flash">
							...
							<param "="" ="="" value="showtime=true&xml=http://softwindproductions.com/NewFolkrider/Music/Artists/Kieth_B/kieth.xml" name="flashvars">
						</object>
					</td>
				</tr>
			</table>
